...
class Creator(Person):
  identifier: Optional[str] = Field(description="ORCID identifier for creator.",
                                    pattern=orcid_pattern,
                                    options={
                                      "placeholder": orcid_pattern_placeholder},
                                    errorMessage={
                                      "pattern": orcid_pattern_error}
                                    )
  email: Optional[EmailStr] = Field(
...
class InLanguageStr(str):
  @classmethod
  def __modify_schema__(cls, field_schema: Dict[str, Any]) -> None:
    field_schema.update(type='string', title='Other',
...
class PropertyValue(PropertyValueBase):
  ...
  value: Union[str, PropertyValueBase, List[PropertyValueBase]
               ] = Field(description="The value of the property.")


class Place(SchemaBaseModel):
  type: str = Field(alias="@type", default="Place",
...
class MediaObject(SchemaBaseModel):
  type: str = Field(alias="@type", default="MediaObject",
